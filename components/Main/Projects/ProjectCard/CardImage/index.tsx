  ...
  return (
    <div
      className={classNames(
        'z-10 col-span-full row-span-full h-full rounded-md bg-amber-100 opacity-5 transition-all md:row-start-2 md:row-end-6 md:opacity-40 md:hover:z-20 md:hover:bg-transparent md:hover:opacity-100 xl:row-span-full',
        index % 2 == 0
