    ...
    >
      <button
        ...
        className={classNames(
          'h-12 w-44 min-w-max rounded-t-md border-amber-100 text-center focus-visible:bg-amber-200 focus-visible:bg-opacity-10 focus-visible:text-amber-300 focus-visible:outline-none sm:w-full sm:rounded-t-none sm:rounded-r-md sm:border-l-2 sm:border-b-0 sm:text-left',
          index == currTab
